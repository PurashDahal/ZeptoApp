...
import 'package:singleclinic/screens/history_screen.dart';
...
String SERVER_ADDRESS = "https://sansarhealth.com";
          ...
          child: Container(
            ...
            child: BottomNavigationBar(
              ...
              items: [
                ...
                BottomNavigationBarItem(
                  icon: Icon(
                    currentTab == 2 ? CupertinoIcons.person : CupertinoIcons.person,
                ...
                BottomNavigationBarItem(
                    icon: Icon(
                      currentTab == 3 ? Icons.health_and_safety_outlined : Icons.health_and_safety_outlined,
                ...
                BottomNavigationBarItem(
                  icon: Icon(
                    currentTab == 3 ? Icons.workspaces_outline : Icons.workspaces_outline,
                    color: currentTab == 3 ? NAVY_BLUE : LIGHT_GREY_TEXT,
                  ),
                  label: "Packages",
                ),
