...
class _DoctorChatScreenState extends State<DoctorChatScreen> {
  ...
  searchChat() {
    ...
    chatList.forEach((element) {
      if(element.messageWith.toLowerCase().contains(searchController.text.toLowerCase())) {
        setState(() {
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Container(
                                      child: Icon(CupertinoIcons.person_alt, color: primaryColor,),
                                      ...
                                      children: [
                                        Text(
                                          searchedChatList.length != null
                                              ? searchedChatList[index].messageWith
                                        ...
                                        SizedBox(
                                          ...
                                          child: Text(
                                            searchedChatList.length != null
                                              ? searchedChatList[index].message
