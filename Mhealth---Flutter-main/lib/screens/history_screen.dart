    ...
    return InkWell(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 10,),
          Divider(color: LIGHT_GREY_TEXT, thickness: 1,),
          SizedBox(height: 30,),
      ...
      child: Column(
        ...
        children: [
          ListTile(
            ...
            title: Text("My Subscriptions", style: TextStyle(fontSize: 20),),
          ...
          ListTile(
            ...
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (c)=>AppointmentScreen()))
          ),
          SizedBox(height: 30,),
          ListTile(
            trailing: Icon(Icons.arrow_forward_ios),
