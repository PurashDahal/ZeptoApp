...
class DoctorItemVertical extends StatelessWidget {
  ...
  const DoctorItemVertical({Key key,this.doctor,this.onTap}) : super(key: key);
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: ScopedModel<DepartmentScopedModel>(
            ...
            child: Builder(
              builder: (context) {
                DepartmentScopedModel.of(context)
                    .getDepartments();
                return Column(
                          ...
                          builder: (context, child, model) {
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                doctorDetails(
                                    title: "Department",
                                    data: "${doctorDepartment.name ?? "not available"}"
                                ),
                                SizedBox(height: 10,),
                                doctorDetails(
                                    title: "Qualification",
                                    data: "${doctor.qualification ?? "not available"}",
                                ),
                                SizedBox(height: 10,),
                                doctorDetails(
                                  title: "Experience",
