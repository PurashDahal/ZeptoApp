...
import 'package:singleclinic/screens/home/components/health_packages.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  var screenWidth;
  File imageFile;
  var uploadPrescriptionTxt = "Diagnostic Services Professional Consultation Tooth Diagnostic Services Professional Consultation Tooth";
                      ...
                      child: ScopedModel<CartModel>(
                          ...
                          child: Builder(builder: (context) {
                            ...
                            return ScopedModelDescendant<CartModel>(builder: (context, _, model) {
                              // model.getCartList();
                              return Text(CartModel.of(context).cart?.length.toString() ?? "0",style: TextStyle(
              ...
              GestureDetector(
                onTap: () {
                  showUploadPrescriptionDialog(
                      ...
                      prescriptionDeliveryAddressController: prescriptionDeliveryAddressController,
                      prescriptionMessageController: prescriptionMessageController,
                      prescriptionMobileController: prescriptionMobileController,
