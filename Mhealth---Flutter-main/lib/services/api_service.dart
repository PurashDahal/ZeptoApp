...
class ApiService{
  ...
  Future<List<Department>> getDepartments()async{
    ...
    if(response.statusCode==200){
      ...
      print(response.body);
      return json['data']['data'].map<Department>((item)=>Department.fromMap(item)).toList();
    }
  ...
  Future<List<Doctor>> getDoctors()async{
    ...
    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      return json['data']['data'].map<Doctor>((item)=>Doctor.fromMap(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<Hospital>> getHospitals(var data )async{
    http.Response response = await http.get(Uri.parse(HOSPITALS).replace(queryParameters: data));
    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      if(json['data']['last_page']==(int.parse(data['page'])-1)){
      ...
      return json['data']['data'].map<Hospital>((item)=>Hospital.fromMap(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<Product>> getProducts({data=const{}})async{
    ...
    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      return json['data']['data'].map<Product>((item)=>Product.fromJson(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<Category>> getCategories()async{
    ...
    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      return json['data'].map<Category>((item)=>Category.fromMap(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<Patient>> getPatients()async{
    ...
    http.Response response = await http.get(Uri.parse(PATIENTS),headers: headers);
    print(response.body);

    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      return json['data'].map<Patient>((item)=>Patient.fromJson(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<DoctorAppointment>> getDoctorAppointment()async{
    ...
    http.Response response = await http.get(Uri.parse(DOCTOR_APPOINTMENTS),headers: headers);
    print(response.body);

    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      return json['data'].map<DoctorAppointment>((item)=>DoctorAppointment.fromJson(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<List<Appointment>> getAppointment()async{
    ...
    http.Response response = await http.get(Uri.parse(APPOINTMENTS),headers: headers);
    print(response.body);

    if(response.statusCode==200){
      var json=jsonDecode(response.body);
      print(response.body);
      return json['data'].map<Appointment>((item)=>Appointment.fromJson(item)).toList();
    }
    throw Exception("Error");
  ...
  Future<ApointmentStatus> bookAppointment({data:const{}})async{
    ...
    http.Response response = await http.post(Uri.parse(BOOK_APPOINTMENT),headers: headers,body: data);
    print(response.body);
